...
export declare type ExpressSessionConfig = {
    /**
...
export declare type Options = OptionsGetPaymentDetails | OptionsReservePayment | OptionsConfirmPayment | OptionsRefundPayment | OptionsGetAuthorizationDetails | OptionsCapture | OptionsVoidAuthorization | OptionsPreApprovedPayment | OptionsCheckRegKeyStatus | OptionsExpireRegKey;
export declare type OptionsGetPaymentDetails = {
    /**
...
export declare type OptionsReservePayment = {
    /**
     * Product Name (charset: UTF-8)
     * (4000 Bytes)
     */
...
export declare type OptionsConfirmPayment = {
    /**
     * Payment amount
     */
    amount: number;
...
export declare type OptionsRefundPayment = {
    /**
     * Refund amoun
     *
...
export declare type OptionsGetAuthorizationDetails = {
    /**
...
export declare type OptionsCapture = {
    /**
     * Payment amount
     */
    amount: number;
...
export declare type OptionsVoidAuthorization = {
    /**
     * Transaction number issued by LINE Pay
     */
    transactionId: string;
...
export declare type OptionsPreApprovedPayment = {
    /**
     * Product name
     * (4000 Bytes)
     */
...
export declare type OptionsCheckRegKeyStatus = {
    /**
...
export declare type OptionsExpireRegKey = {
    /**
     * Key which is returned from reserve API
     */
    regKey: string;
...
export declare type Query = QueryGetPaymentDetails | QueryGetAuthorizationDetails | QueryCheckRegKeyStatus;
export declare type QueryGetPaymentDetails = {
    /**
     * A transaction ID issued by LINE Pay, for payment or refund.
     */
    transactionId?: string | string[];
...
export declare type QueryGetAuthorizationDetails = {
    /**
     * A transaction ID issued by LINE Pay, for payment or refund.
     */
    transactionId?: string | string[];
...
export declare type QueryCheckRegKeyStatus = {
    /**
     * Check Authorization for Credit Card minimum amount saved in regKey
     *
     * true:
